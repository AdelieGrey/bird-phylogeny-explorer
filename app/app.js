...
function renderSourceNote() {
  els.sourceNote.innerHTML = `
    ...
    <span class="source-status">当前版本包含 ${data.meta.includedOrders} 个目、${data.meta.includedFamilies} 个科、${data.meta.includedGenera || 0} 个属、${data.meta.includedSpecies} 个物种。</span>
  `;
}
